...
class Mybike_xml_generator extends Module
{
    ...
    public function uninstall()
    {
        $keys = [
            ...
            // XML run stats
            'MYBIKE_LAST_FULL_RUN',  'MYBIKE_LAST_FULL_COUNT',  'MYBIKE_LAST_FULL_DURATION',  'MYBIKE_LAST_FULL_STATUS',
            'MYBIKE_LAST_COMB_RUN',  'MYBIKE_LAST_COMB_COUNT',  'MYBIKE_LAST_COMB_DURATION',  'MYBIKE_LAST_COMB_STATUS',
            'MYBIKE_LAST_STOCK_RUN', 'MYBIKE_LAST_STOCK_COUNT', 'MYBIKE_LAST_STOCK_DURATION', 'MYBIKE_LAST_STOCK_STATUS',
            // API sync stats
            'MYBIKE_LAST_API_SYNC_RUN', 'MYBIKE_LAST_API_SYNC_COUNT',
            'MYBIKE_LAST_API_SYNC_DURATION', 'MYBIKE_LAST_API_SYNC_STATUS',
            // PS import stats
            'MYBIKE_LAST_IMPORT_RUN', 'MYBIKE_LAST_IMPORT_IMPORTED', 'MYBIKE_LAST_IMPORT_UPDATED',
            'MYBIKE_LAST_IMPORT_SKIPPED', 'MYBIKE_LAST_IMPORT_DURATION', 'MYBIKE_LAST_IMPORT_STATUS',
            // Test import stats
            'MYBIKE_LAST_TEST_RUN', 'MYBIKE_LAST_TEST_STATUS', 'MYBIKE_LAST_TEST_DETAIL',
        ];
        foreach ($keys as $key) {
