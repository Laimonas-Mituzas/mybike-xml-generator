 ...
 * Run after cron_api_sync.php (stock mode).
 */
...
try {
    ...
    mybike_set_config('MYBIKE_LAST_STOCK_COUNT',    (string)$count);
    mybike_set_config('MYBIKE_LAST_STOCK_DURATION', (string)$duration);
